...
func (p *PredPolygonJson) Geo(f geo.PostGISFunc) entitysql.PredicateFunc {
...
func (p *PredPolygonJson) GeoColumn() geo.PostGISFunc {
	return geo.PostGISFunc{
		Entity: Entity,
		Column: string(FieldPolygonJson.Name),
	}
}
...
func (p *PredPolygonJson) ST_Contains(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Contains",
...
func (p *PredPolygonJson) ST_Crosses(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Crosses",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Disjoint(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Disjoint",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Equals(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Equals",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Intersects(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Intersects",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Overlaps(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Overlaps",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Touches(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Touches",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Within(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Within",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_Distance(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Distance",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_DWithin(f1 geo.PostGISFunc, f2 geo.PostGISFunc, distance float64) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_DWithin",
		Value:    []any{distance},
		Children: []geo.PostGISFunc{f1, f2},
...
func (p *PredPolygonJson) ST_Length(f geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Length",
...
func (p *PredPolygonJson) ST_Area(f geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Area",
		Children: []geo.PostGISFunc{f},
	}
...
func (p *PredPolygonJson) ST_Buffer(f geo.PostGISFunc, distance float64) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Buffer",
		Value:    []any{distance},
		Children: []geo.PostGISFunc{f},
...
func (p *PredPolygonJson) ST_MakePoint(lng float64, lat float64) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:  "ST_MakePoint",
		Value: []any{lng, lat},
	}
...
func (p *PredPolygonJson) ST_MakeLine(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_MakeLine",
		Children: []geo.PostGISFunc{f1, f2},
	}
...
func (p *PredPolygonJson) ST_MakePolygon(f geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_MakePolygon",
		Children: []geo.PostGISFunc{f},
	}
...
func (p *PredPolygonJson) ST_MakeEnvelope(xmin float64, ymin float64, xmax float64, ymax float64, srid geo.SRID) geo.PostGISFunc {
	return geo.PostGISFunc{
...
func (p *PredPolygonJson) ST_Multi(f geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Multi",
		Children: []geo.PostGISFunc{f},
	}
...
func (p *PredPolygonJson) ST_Transform(f geo.PostGISFunc, srid geo.SRID) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Transform",
		Value:    []any{srid},
		Children: []geo.PostGISFunc{f},
...
func (p *PredPolygonJson) ST_SetSRID(f geo.PostGISFunc, srid geo.SRID) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_SetSRID",
...
func (p *PredPolygonJson) ST_GeomFromText(wkt string) geo.PostGISFunc {
	return geo.PostGISFunc{
...
func (p *PredPolygonJson) ST_Union(f1 geo.PostGISFunc, f2 geo.PostGISFunc) geo.PostGISFunc {
	return geo.PostGISFunc{
		Name:     "ST_Union",
		Children: []geo.PostGISFunc{f1, f2},
	}
